...
const Checking = () => {
  ...
  const handleView = (row) => {
    ...
    // open a modal or navigate to detail page
  ...
  return (
    <div className="bg-white w-full rounded-md border border-gray-200 shadow-sm -mt-3 mb-4 p-2 min-h-[calc(100vh-10rem)]">
      ...
      <div className="flex items-center justify-end gap-2 mb-2">
        ...
        {/* Search */}
        <div className="flex items-center border border-gray-300 rounded-md overflow-hidden w-1/4">
          <input
            type="text"
            placeholder="Search..."
            value={search}
            onChange={(e) => setSearch(e.target.value)}
            className="text-xs flex-1 px-3 py-1.5 focus:outline-none"
          />
