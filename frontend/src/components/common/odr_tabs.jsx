      ...
      >
        ...
        >
          <div className="grid grid-cols-3 gap-3 p-1">
            ...
            >
              ...
              <p className="text-sm mt-3">
                Your document request PIN (4 digit) together with the REFERENCE
                NO. is now required for tracking. You can find the PIN on the
                confirmation email sent to you. You can ask the assistance of
                the Registration Services office if you accidentally deleted the
                email.
              </p>
            </div>
          </div>
          ...
          <div className="flex  w-full max-w-full translate-y-4 p-1">
            <div className="flex items-center flex-1 border border-gray-900 rounded-md bg-white">
