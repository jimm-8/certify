...
const toneClasses = {
  success: "border-[var(--school-green)]/30 bg-[var(--school-green)]/10 text-[var(--school-green)]",
  error: "border-[var(--school-crimson)]/25 bg-[var(--school-crimson)]/10 text-[var(--school-crimson)]",
  warning: "border-[var(--school-gold)]/40 bg-[var(--school-gold)]/15 text-[#9a6100]",
  info: "border-[var(--school-blue)]/25 bg-[var(--school-blue)]/10 text-[var(--school-blue)]",
  default: "border-[var(--school-gray)]/25 bg-[var(--school-ivory)] text-[var(--school-ink)]",
};
        ...
        <div className="mt-5 flex gap-2">
          {cancelLabel && (
            <button
              ...
              onClick={handleClose}
              disabled={loading}
              className="w-1/2 rounded-md border border-[var(--school-border)] bg-white px-4 py-2 text-xs font-medium text-gray-600 transition hover:bg-[var(--school-ivory)] disabled:opacity-50"
            >
              {cancelLabel}
            </button>
          )}
          ...
          <button
            ...
            className={`${
              cancelLabel ? "w-1/2" : "w-full"
            } flex items-center justify-center gap-2 rounded-md border border-[var(--school-crimson)] bg-[var(--school-crimson)] px-4 py-2 text-xs font-medium text-white transition hover:bg-[#b61d24] disabled:opacity-50`}
          >
            {loading && (
